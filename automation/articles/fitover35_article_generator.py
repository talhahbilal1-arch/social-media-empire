...
- Product recommendations with Amazon affiliate links (tag: fitover3509-20)
...
def main():
    ...
    site = BRAND_SITE_CONFIG.get('fitness', {})
    ...
    html = render_article_from_template('fitness', template_data, site, slug)
