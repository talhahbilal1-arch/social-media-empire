...
export const BRAND_CONFIG: Record<string, BrandConfig> = {
  daily_deal_darling: {
    ...
    pinterest: {
      accountId: process.env.PINTEREST_DDD_ACCOUNT_ID || '',
      boardId: process.env.PINTEREST_DDD_BOARD_ID || '',
      apiKey: process.env.LATE_API_KEY_DDD || '',
  ...
  menopause_planner: {
    ...
    pinterest: {
      accountId: process.env.PINTEREST_MENO_ACCOUNT_ID || '',
      boardId: process.env.PINTEREST_MENO_BOARD_ID || '',
      apiKey: process.env.LATE_API_KEY_MENO || '',
