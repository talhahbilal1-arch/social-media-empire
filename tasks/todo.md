...
- [x] **Refresh LATE_API_KEY (Zernio)**: Updated to new API key ✅ COMPLETED 2026-03-21
  - Updated via GitHub Secrets (timestamp: 2026-03-22T06:50:32Z)
  - Impact: Fixes content-engine.yml and video-pins.yml dependencies
...
- [ ] **Refresh LINKEDIN_ACCESS_TOKEN**: Regenerate LinkedIn API credentials before expiration
  ...
  - Status: PENDING — User to generate LinkedIn app and provide token
