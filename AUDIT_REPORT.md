...
**Key findings:**
- 13 FitOver35 articles had wrong affiliate tags (dailydealdarl-20 instead of fitover3509-20) — **FIXED**
...
13 article files in `outputs/fitover35-website/articles/` still had `dailydealdarl-20` — these were generated before the code fix was applied.

### Fix Applied
Batch replaced `dailydealdarl-20` → `fitover3509-20` in all 13 files:
...
### Verification
Post-fix grep confirms **zero** instances of `dailydealdarl-20` in FitOver35 articles.
