        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/submit/" className="text-dt-muted hover:text-accent text-sm transition-colors">Submit a Tool</Link></li>
              <li><Link href="/sitemap.xml" className="text-dt-muted hover:text-accent text-sm transition-colors">Sitemap</Link></li>
            </ul>
          </div>
          <div>
            <h3 className="font-semibold text-dt mb-4">About</h3>
            <p className="text-dt-muted text-sm mb-4">
              Independent AI tool reviews by <strong className="text-dt">Talhah Bilal</strong>, ISSA certified.
              460+ tools reviewed. Zero paid placements.
            </p>
            <ul className="space-y-2">
              <li><Link href="/about/" className="text-dt-muted hover:text-accent text-sm transition-colors">About Us</Link></li>
              <li><Link href="/editorial-guidelines/" className="text-dt-muted hover:text-accent text-sm transition-colors">Editorial Guidelines</Link></li>
              ...
              <li><Link href="/terms/" className="text-dt-muted hover:text-accent text-sm transition-colors">Terms of Service</Link></li>
        ...
        <div className="mt-8 pt-8 border-t border-dark-border flex flex-col sm:flex-row justify-between items-center gap-4">
          <div>
            <p className="text-dt-muted text-sm">
              &copy; {new Date().getFullYear()} PilotTools &mdash; Founded by{' '}
              <Link href="/about/" className="text-dt hover:text-accent transition-colors">Talhah Bilal</Link>.
              All rights reserved.
            </p>
            <p className="text-dt-muted text-xs mt-1">
              Independent AI tool reviews. Not affiliated with any AI company or VC firm.
            </p>
          </div>
          <p className="text-dt-muted text-xs max-w-xs text-center sm:text-right">
            Some links are affiliate links. We may earn a commission at no extra cost to you.{' '}
            <Link href="/affiliate-disclosure/" className="text-accent hover:text-cyan-300 transition-colors">Disclosure</Link>
          </p>
        </div>
      </div>
    </footer>
